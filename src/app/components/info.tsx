...
export default function Info() {
    return (
        <div className='info-content'>
            ...
            <p>I'm a Frontend Developer passionate about creating intuitive and engaging user experiences.  
                I specialize in React, Next.js, and Tailwind CSS – transforming ideas into beautifully crafted products.</p>
            <h1 className='achivements-h1'>Achivements:</h1>
            ...
            <p>I love solving problems, continuously learning, and working with teams to build meaningful digital products.  
